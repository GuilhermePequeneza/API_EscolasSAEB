    ...
    public class IdebController : ControllerBase
    {
            ...
            [FromQuery] FiltroEscolasRequest filtros = null)
        {
            try
            {
                ...
                // Mapear para o DTO de resposta (limitado a 1000 registros)
        ...
        public async Task<IActionResult> CarregarPlanilhas()
        {
            try
            {
                ...
                _logger.LogInformation("Carga concluída. {Count} escolas processadas", escolas.Count);

                return Ok(new
                {
                    mensagem = "Planilhas carregadas e dados inseridos com sucesso",
